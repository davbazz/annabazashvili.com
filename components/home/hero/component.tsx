      ...
      <Container>
        <div className="relative flex w-full items-start justify-between">
          <div className="flex w-[60%] flex-col gap-12 text-nowrap xl:gap-16">
            <h1
              className={`${montserrat.className} inline-block w-[400px] text-[22px] font-[700] leading-[34px] sm:w-auto sm:text-3xl sm:leading-[40px] xl:text-4xl xl:leading-[48px]`}
            >
            ...
            <h3 className="inline-block w-[210px] text-wrap text-sm font-[500] italic leading-6 sm:w-[300px] md:w-[360px] lg:w-[420px] xl:w-[480px] xl:text-base xl:leading-7">
          ...
          <div className="relative -ml-7 -mr-0 mt-14 flex h-[150%] w-[150%] items-center justify-center sm:-ml-4 md:-ml-6 md:mt-12 md:h-[300px] md:w-[300px] lg:-mr-10 lg:-mt-12 lg:ml-0 lg:h-[460px] lg:w-[460px] xl:-mt-20 xl:h-[700px] xl:w-[700px]">
            <Blob />
            <iframe
